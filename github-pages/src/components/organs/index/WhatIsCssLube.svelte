...
<div class={styles.$common.contents_div}>
	...
	<span>In addition, CSS Lube parses HTML documents at runtime and render styles, so it can completely replace style files that become bloated whenever updated with a 6,323 byte(2,709 byte on gzip) js file.</span>
	<div class="h=1"></div>
	<div class="flex
			@!md@column
			@!lg@_pre/fs=.7">
