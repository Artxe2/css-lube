...
import { declare, name, string } from "js/highlighter.js"

const code = `${declare("let")} ${name("style")} = ${string(`*{margin:0;padding:0;font:inherit;color:inherit}
...
<div class="m=1_0_2_0">
	<CodePage is_code>{@html code}</CodePage>
</div>