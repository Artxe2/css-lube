export default {
	background: {
		grid: "bgi=linear-gradient(#fff_2px,transparent_2px),linear-gradient(90deg,#fff_2px,transparent_2px),linear-gradient(rgba(255,255,255,.3)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.3)_1px,transparent_1px) background-size=10em_10em,10em_10em,2em_2em,2em_2em"
	},
	button: {
