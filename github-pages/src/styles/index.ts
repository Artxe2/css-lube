export default {
    ...
    button: {
        ...
        resources: "h=2 bg=--chambray @dark@bg=--firefly br=.25 pl=.75 pr=.75 bd=2px_solid_--chambray :hover/bg=--havelock-blue",
        link: "c=--primary p=.5 br=.5 :hover/c=--primary-light;bold :active/c=--primary!",
        text: "p=.5 br=.5 :hover/bg=#eee :active/bg=#ddd! @dark@:hover/bg=#333 @dark@:active/bg=#444!",
        themeSelector: "bg=--chambray :hover/bg=--havelock-blue w=6.25 h=2.5 br=.25"
    },
    scrollbar: {
        primary: "::-webkit-scrollbar/w=.5 ::-webkit-scrollbar-track/bg=--chambray-55 ::-webkit-scrollbar-thumb/bg=--chambray;br=.25"
    }
}