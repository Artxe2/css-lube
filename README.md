...
In addition, CSS Lube parses HTML documents at runtime and render styles, so it can completely replace style files that become bloated whenever updated with a 6,002 byte(2,562 byte on gzip) js file.
...
![WebPageTest](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/wux8teuenw19j3zcbh06.png)
