...
/* <- regex / function -> */
	...
	let checkClass = t => {
		if (classes.size != classes.add(t).size) compileStyle(t)
	}
	let searchClassList = target => target.classList.forEach(checkClass)
	let buildStyleSheet = () => {
		requestId = 0
...
/* <- function / runtime -> */
	...
	styleSheet.setAttribute("css-lube", "v1.0.3")
