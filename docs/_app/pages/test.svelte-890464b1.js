import{S as u,i as p,s as h,e as t,k as w,c as s,a as n,d as o,m as x,b as c,g as f,J as v,K as b,v as _}from"../chunks/vendor-830d03de.js";function k(g){let e,d,i,r;return{c(){e=t("div"),d=t("textarea"),i=w(),r=t("div"),this.h()},l(l){e=s(l,"DIV",{id:!0,class:!0});var a=n(e);d=s(a,"TEXTAREA",{id:!0,class:!0}),n(d).forEach(o),i=x(a),r=s(a,"DIV",{id:!0,class:!0}),n(r).forEach(o),a.forEach(o),this.h()},h(){c(d,"id","editor"),c(d,"class","bg=#00000000;w=50%;border=1px_solid_black"),d.value=`<div id="view">
...
</div>`,c(r,"id","view"),c(r,"class","width=50%;border=1px_solid_black"),c(e,"id","root"),c(e,"class","bg=#dddddd;w=100%;min-height=100%;display:flex")},m(l,a){f(l,e,a),v(e,d),v(e,i),v(e,r)},p:b,i:b,o:b,d(l){l&&o(e)}}}function m(g){return _(()=>{const e=document.querySelector("#editor"),d=document.querySelector("#view");d.innerHTML=e.value,e.addEventListener("input",i=>{d.innerHTML=e.value}),document.querySelectorAll("div[class]").forEach(i=>{i.setAttribute("title",i.getAttribute("class"))})}),[]}class E extends u{constructor(e){super();p(this,e,m,k,h,{})}}export{E as default};
