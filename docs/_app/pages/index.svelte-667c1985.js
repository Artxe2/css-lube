import{S as u,i as h,s as p,e as t,k as w,c as s,a as n,d as l,m as _,b as c,g as x,J as v,K as b,v as k}from"../chunks/vendor-f0095a1c.js";function f(g){let e,d,i,r;return{c(){e=t("div"),d=t("textarea"),i=w(),r=t("div"),this.h()},l(o){e=s(o,"DIV",{id:!0,class:!0});var a=n(e);d=s(a,"TEXTAREA",{id:!0,class:!0}),n(d).forEach(l),i=_(a),r=s(a,"DIV",{id:!0,class:!0}),n(r).forEach(l),a.forEach(l),this.h()},h(){c(d,"id","editor"),c(d,"class","bg=#00000000;width=50%;border=1px_solid_black"),d.value=`<div id="view">
    ...
    <div class="display=flex;border=1px_solid_black _div/margin=10px">
        ...
        <div class="background-color=red @min-width=400px@:active/background-color=blue @!screen&width=400~600@:active/background-color=green">active</div>
    </div>
</div>`,c(r,"id","view"),c(r,"class","width=50%;border=1px_solid_black"),c(e,"id","root"),c(e,"class","bg=#dddddd;width=100%;height=100%;display:flex")},m(o,a){x(o,e,a),v(e,d),v(e,i),v(e,r)},p:b,i:b,o:b,d(o){o&&l(e)}}}function m(g){return k(()=>{const e=document.querySelector("#editor"),d=document.querySelector("#view");d.innerHTML=e.value,e.addEventListener("input",i=>{d.innerHTML=e.value}),document.querySelectorAll("div[class]").forEach(i=>{i.setAttribute("title",i.getAttribute("class"))})}),[]}class E extends u{constructor(e){super();h(this,e,m,f,p,{})}}export{E as default};
