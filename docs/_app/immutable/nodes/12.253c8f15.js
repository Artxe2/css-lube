...
<span class="bold c=--electric-violet @dark@c=--bouquet">{ color: red }</span>
`)}
`]}class $e extends H{constructor(e){super(),V(this,e,ne,ae,D,{})}}function le(l){let e,s;return{c(){e=new O(!1),s=y(),this.h()},l(t){e=R(t,!1),s=y(),this.h()},h(){e.a=s},m(t,n){e.m(l[0],t,n),p(t,s,n)},p:U,d(t){t&&(i(s),e.d())}}}function ce(l){let e,s;return e=new W({props:{$$slots:{default:[le]},$$scope:{ctx:l}}}),{c(){_(e.$$.fragment)},l(t){g(e.$$.fragment,t)},m(t,n){w(e,t,n),s=!0},p(t,[n]){const f={};n&2&&(f.$$scope={dirty:n,ctx:t}),e.$set(f)},i(t){s||(b(e.$$.fragment,t),s=!0)},o(t){v(e.$$.fragment,t),s=!1},d(t){q(e,t)}}}function re(l){return[`${d("style",` ${c("css-lube")}=${r("v1.2.1")}`,`
	${m(".c\\=red",["color","red"])}
...
<span class="bold c=--electric-violet @dark@c=--bouquet">{ font-size: 10px }</span>
`)}
`]}class de extends H{constructor(e){super(),V(this,e,fe,pe,D,{})}}function me(l){let e,s;return{c(){e=new O(!1),s=y(),this.h()},l(t){e=R(t,!1),s=y(),this.h()},h(){e.a=s},m(t,n){e.m(l[0],t,n),p(t,s,n)},p:U,d(t){t&&(i(s),e.d())}}}function ue(l){let e,s;return e=new W({props:{$$slots:{default:[me]},$$scope:{ctx:l}}}),{c(){_(e.$$.fragment)},l(t){g(e.$$.fragment,t)},m(t,n){w(e,t,n),s=!0},p(t,[n]){const f={};n&2&&(f.$$scope={dirty:n,ctx:t}),e.$set(f)},i(t){s||(b(e.$$.fragment,t),s=!0)},o(t){v(e.$$.fragment,t),s=!1},d(t){q(e,t)}}}function he(l){return[`${d("style",` ${c("css-lube")}=${r("v1.2.1")}`,`
	${u("@media not")} ${$("(")}${c("min-width")}:${r("768px",!1)}${$("){")}
		${m(".\\@\\!min-width\\=768px\\@fs\\=12px",["font-size","12px"])}
	${$("}")}
`)}
