<script lang="ts">
import PriorityText from "src/components/atoms/animations/PriorityText.svelte";
...
<div>
    ...
    <div class="bg=#bbb inlineBlock textAlign=left fw=bold p=0.5">
        &lt;style&gt;<br />
        &nbsp;&nbsp;&nbsp;&nbsp;...<br />
        &nbsp;&nbsp;&nbsp;&nbsp;{"[class][class][class]"}.c\=yellow\!\!\!{"{color:yellow}"}<br />
        &nbsp;&nbsp;&nbsp;&nbsp;{"[class][class]"}.c\=orange\!\!{"{color:orange}"}<br />
        &nbsp;&nbsp;&nbsp;&nbsp;{"[class]"}.c\=red\!{"{color:red}"}<br />
        &lt;/style&gt;
    </div><br />
    <br />
    <PriorityText />
