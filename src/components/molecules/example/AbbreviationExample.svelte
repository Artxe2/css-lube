...
<div class="text-align=center">
    ...
    <MorphingText
        array={[
            `<span class="c=red">fontSize=14px</span>`,
    ...
    <MorphingText
        array={[
            `<span class="c=red">fs=calc(10px/2)</span>`,
    ...
    <MorphingText
        array={[
            `<span class="c=red">c=--primary</span>`,
