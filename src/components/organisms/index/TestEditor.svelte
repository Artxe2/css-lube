...
export const toggleView = () => {
    root.className = root.className.replace(/[^ ]+/, /^a/.test(root.className) ? "none" : "absolute")
}
onMount(() => {
...
<div id="root" class="absolute bg=#dddddd w=90vw h=90vh left=5vw top=5vh" bind:this={root}>
